...
public class UserAccountRedirectCommand implements Command {
    private static final Logger LOGGER = Logger.getLogger(UserAccountRedirectCommand.class);
    private static Command instance = new UserAccountRedirectCommand();
    private UserAccountRedirectCommand  (){}
    ...
    public String execute(HttpServletRequest request) {
       ...
       try {
           ...
           request.setAttribute("fotoMap",FotoService.getInstance().getFotoInformationMap(user.getId(),loginedUserId));
